...
call cd golang
call docker build -t pusher-channel-go .
call docker run -p 127.0.0.1:2000:3000 -e PUSHER_APP_ID="%AppId%" -e PUSHER_APP_KEY="%AppKey%" -e PUSHER_APP_SECRET="%SecretKey%" -e PUSHER_APP_CLUSTER="%AppCluster%" -e PUSHER_APP_SECURE="1" pusher-channel-go
